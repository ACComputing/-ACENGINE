...
LANG = {
  "English": {
    ...
    "debug":"Debug","settings":"Project Settings","scenes":"Scene Manager",
    "about":"About AC Engine","docs":"Documentation","shortcuts":"Keyboard Shortcuts",
    "tab_scene":"Scene Editor","tab_events":"Event Editor",
    "tab_blueprints":"Blueprints","tab_vibe":"Vibe Coder AI",
    "objects":"Objects","layers":"Layers","scenes_panel":"Scenes",
  ...
  "日本語": {
    ...
    "debug":"デバッグ","settings":"プロジェクト設定","scenes":"シーン管理",
    "about":"AC Engineについて","docs":"ドキュメント","shortcuts":"キーボードショートカット",
    "tab_scene":"シーンエディタ","tab_events":"イベントエディタ",
    "tab_blueprints":"ブループリント","tab_vibe":"バイブコーダーAI",
    "objects":"オブジェクト","layers":"レイヤー","scenes_panel":"シーン",
  ...
  "中文": {
    ...
    "debug":"调试","settings":"项目设置","scenes":"场景管理",
    "about":"关于AC Engine","docs":"文档","shortcuts":"快捷键",
    "tab_scene":"场景编辑器","tab_events":"事件编辑器",
    "tab_blueprints":"蓝图","tab_vibe":"氛围编码AI",
    "objects":"对象","layers":"图层","scenes_panel":"场景",
    ...
    "bp_branch":"分支","bp_sequence":"序列","bp_for_each":"遍历",
...
T = {
    ...
    "scene_bg":"#282840","scene_grid":"#33335A","tab_bg":"#252540",
...
class ACEngine:
    def __init__(self, root):
        ...
        self._build_ui()
        self._defaults()
        self._log("AC Engine v1.0 initialized — Team Flames / Samsoft")
    ...
    def _right_panel(self):
        ...
        tk.Label(self.rp, text=f"  {self.t('properties')}", font=("Segoe UI",10,"bold"),
                 bg=T["panel_header"], fg=T["tab_active_fg"], anchor="w").pack(fill="x", ipady=4)
    ...
    def _scene_tab(self):
        ...
        tk.Label(cof, text=f"  {self.t('console')}", font=("Segoe UI",8,"bold"),
                 bg=T["panel_header"], fg=T["tab_active_fg"], anchor="w").pack(fill="x")
    ...
    def _redraw(self):
        ...
        c.create_text(ox+pw//2, oy-10, text="640 × 480", fill=T["accent"], font=("Consolas",8))
        # Objects
    ...
    def _defaults(self):
        # UPDATED: Emptied defaults to match Clickteam Fusion's blank canvas approach
        self.objects = []
        self.events = []
        self.bp_nodes = []
        self.bp_conns = []
